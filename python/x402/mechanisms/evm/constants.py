...
# Permit2 EIP-712 witness types for Upto PermitWitnessTransferFrom
# Differs from exact by including the facilitator in the witness.
...
# x402UptoPermit2Proxy settle ABI
